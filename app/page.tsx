    ...
    <section className="flex flex-col gap-2 min-w-full min-h-screen ">
      ...
      <div className="flex flex-col gap-8 px-4 xl:px-[15%] pt-5 pb-14">
        <div className="flex flex-col gap-4 ">
          <h2 className={`${fontRoboto.className} text-2xl text-center`}>
          ...
          <p className={`${fontQuicksand.className} text-lg`}>
            El crecimiento empresarial en Colombia ha experimentado un notable
            impulso en las últimas décadas, marcando una transformación
            significativa en el panorama económico del país. Este fenómeno se ha
            visto favorecido por una combinación de factores, que incluyen
            políticas gubernamentales orientadas al fomento de la inversión,
            mejoras en la infraestructura, estabilidad macroeconómica y un
            aumento en la participación de Colombia en el comercio
            internacional.
          </p>
        ...
        <h4 className={`${fontRoboto.className} text-2xl`}>
          Noticías destacadas
        </h4>
    ...
    <div className="max-w-[900px] gap-2 grid grid-cols-12 grid-rows-2 px-8">
      <Card className="col-span-12 sm:col-span-4 h-[300px]">
        <CardHeader className="absolute z-10 top-1 flex-col !items-start">
          ...
          <a
            href="https://mintic.gov.co/portal/inicio/Sala-de-prensa/Noticias/282196:MinTIC-presento-el-programa-Inicia-con-TIC-en-Riochacha"
            target="_blank"
      ...
      <Card className="col-span-12 sm:col-span-4 h-[300px]">
        <CardHeader className="absolute z-10 top-1 flex-col !items-start">
          <a
            href="https://www.minhacienda.gov.co/webcenter/portal/SaladePrensa/pages_DetalleNoticia?documentId=WCC_CLUSTER-232540"
            className="text-white font-medium text-large"
          >
      ...
      <Card className="col-span-12 sm:col-span-4 h-[300px]">
        <CardHeader className="absolute z-10 top-1 flex-col !items-start">
          <a
            href="https://www.minhacienda.gov.co/webcenter/portal/Minhacienda#!0"
            target="_blank"
            className="text-white font-medium text-large"
          >
            Colombia emitio bonos sociales por 2500 USD
          </a>
        </CardHeader>
        <Image
          removeWrapper
        ...
        <CardFooter className="absolute bg-white/30 bottom-0 border-t-1 border-zinc-100/50 z-10 justify-between">
          <div>
            <p className="text-black text-tiny">
              ¿Quieres exportar tus productos?. Conectate con mercado
      ...
      >
        ...
        <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
          ...
          <Button radius="full" size="sm">
            <a href="https://www.camarabaq.org.co/negocios-mas-productivos">
              Ver más
            </a>
          </Button>
        </CardFooter>
...
function NewCard(props: {
  ...
  return (
    <Card
      isFooterBlurred
      className="h-[300px] col-span-12 sm:col-span-7 min-w-[300px] grow"
    >
      {/* <CardHeader className="absolute z-10 top-1 flex-col items-start">
                <p className="text-tiny text-white/60 uppercase font-bold">Your day your way</p>
                <h4 className="text-white/90 font-medium text-xl">Your checklist for better sleep</h4>
